    ...
    public partial class RTKApplication : Microsoft.UI.Xaml.Application, IXamlExtensionHost
    {
        ...
        private List<IXamlMetadataProvider> OtherProviders
        {
            get
            {
                ...
                //dynamic _this = this;
                //List<IXamlMetadataProvider> otherProviders =
                //    _this._AppProvider.Provider.OtherProviders as List<IXamlMetadataProvider> ?? throw new AccessViolationException(); return otherProviders;
            }
        }
